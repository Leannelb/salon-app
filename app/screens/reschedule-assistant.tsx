      ...
      <Card style={styles.bookingCard}>
        <Card.Content>
          ...
          <View style={styles.detailRow}>
            ...
            <Text variant="bodyMedium" style={styles.detailValue}>{booking.serviceName}</Text>
          </View>
          
          <View style={styles.detailRow}>
            <Text variant="bodyMedium">Date:</Text>
            <Text variant="bodyMedium" style={styles.detailValue}>{formatDate(booking.date)}</Text>
          </View>
          
          <View style={styles.detailRow}>
            <Text variant="bodyMedium">Time:</Text>
            <Text variant="bodyMedium" style={styles.detailValue}>{booking.time}</Text>
          </View>
          
          <View style={styles.detailRow}>
            <Text variant="bodyMedium">Stylist:</Text>
            <Text variant="bodyMedium" style={styles.detailValue}>{booking.stylistName}</Text>
          </View>
          
          <View style={styles.detailRow}>
            <Text variant="bodyMedium">Location:</Text>
            <Text variant="bodyMedium" style={styles.detailValue}>{booking.branchName}</Text>
          </View>
        </Card.Content>
      </Card>
