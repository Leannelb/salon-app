...
export default function BookingManagement() {
      ...
      onDone: () => {
        ...
        setTimeout(() => {
          Alert.alert(
            ...
            "Reschedule my appointment on March 15th",
            [
              { 
  ...
  const confirmCancel = () => {
    if (selectedBooking) {
      ...
      Speech.speak(`Your ${selectedBooking.serviceName} appointment on ${formatDate(selectedBooking.date)} has been cancelled.`);
        ...
        >
          ...
          <Dialog.Content>
            <Text variant="bodyMedium">
              Are you sure you want to cancel your {selectedBooking?.serviceName} appointment 
              on {selectedBooking && formatDate(selectedBooking.date)} at {selectedBooking?.time}?
            </Text>
          </Dialog.Content>
          <Dialog.Actions>
            <Button onPress={() => setCancelDialogVisible(false)}>No, Keep It</Button>
            <Button onPress={confirmCancel} textColor="#F44336">Yes, Cancel</Button>
          </Dialog.Actions>
        </Dialog>
      </Portal>
